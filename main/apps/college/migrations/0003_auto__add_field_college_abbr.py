...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'College.abbr'
        db.add_column('college_college', 'abbr', self.gf('django.db.models.fields.CharField')(default='', max_length=4, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'College.abbr'
        db.delete_column('college_college', 'abbr')
