...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field courses on 'Department'
        db.create_table('college_department_courses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('department', models.ForeignKey(orm['college.department'], null=False)),
            ('course', models.ForeignKey(orm['course.course'], null=False))
        ))
        db.create_unique('college_department_courses', ['department_id', 'course_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field courses on 'Department'
        db.delete_table('college_department_courses')
