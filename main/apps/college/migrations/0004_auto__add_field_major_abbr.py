...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Major.abbr'
        db.add_column('college_major', 'abbr', self.gf('django.db.models.fields.CharField')(default='', max_length=15, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Major.abbr'
        db.delete_column('college_major', 'abbr')
