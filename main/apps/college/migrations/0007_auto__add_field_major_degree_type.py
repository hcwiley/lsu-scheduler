...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Major.degree_type'
        db.add_column('college_major', 'degree_type', self.gf('django.db.models.fields.CharField')(default='', max_length=4, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Major.degree_type'
        db.delete_column('college_major', 'degree_type')
