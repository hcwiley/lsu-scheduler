...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lab.abbr'
        db.add_column('course_lab', 'abbr', self.gf('django.db.models.fields.CharField')(default='', max_length=4, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lab.abbr'
        db.delete_column('course_lab', 'abbr')


    models = {
        'course.course': {
            'Meta': {'ordering': "['abbr', 'number']", 'object_name': 'Course'},
        ...
        'course.lab': {
            ...
            'end_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(0, 45, 14, 298517)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instructor': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'room': ('django.db.models.fields.IntegerField', [], {'default': '42', 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(0, 45, 14, 298459)', 'null': 'True', 'blank': 'True'})
        }
    }
