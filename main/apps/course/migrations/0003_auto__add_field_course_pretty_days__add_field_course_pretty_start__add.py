...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.pretty_days'
        db.add_column('course_course', 'pretty_days', self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True, blank=True), keep_default=False)

        # Adding field 'Course.pretty_start'
        db.add_column('course_course', 'pretty_start', self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True, blank=True), keep_default=False)

        # Adding field 'Course.pretty_end'
        db.add_column('course_course', 'pretty_end', self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.pretty_days'
        db.delete_column('course_course', 'pretty_days')

        # Deleting field 'Course.pretty_start'
        db.delete_column('course_course', 'pretty_start')

        # Deleting field 'Course.pretty_end'
        db.delete_column('course_course', 'pretty_end')
    ...
    models = {
        ...
        'course.lab': {
            ...
            'end_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(12, 42, 27, 130553)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instructor': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'room': ('django.db.models.fields.IntegerField', [], {'default': '42', 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(12, 42, 27, 130512)', 'null': 'True', 'blank': 'True'})
        }
    }
