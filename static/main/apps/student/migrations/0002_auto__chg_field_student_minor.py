...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Student.minor'
        db.alter_column('student_student', 'minor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['college.Minor']))


    def backwards(self, orm):
        
        # Changing field 'Student.minor'
        db.alter_column('student_student', 'minor_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['college.Minor']))
